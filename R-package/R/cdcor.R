...
#' @return \item{ cdcov }{the conditional distance covariance with given
#' variable z } \item{ mcdcov }{mean of the conditional distance covariance
#' with given variable z} \item{ width }{ the bandwidth } \item{ index }{
